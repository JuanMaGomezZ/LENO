...
const burgerVeggies = [
  ...
  {
    id: 132,
    nombre: "Crispy Veggie",
    precio: 750,
    imagen: "/assets/burgers/CrispyVeggie.png",
    carne: "Medallon de Zanahoria frito crispy",
    queso: "Cheddar x2",
    topping1: "Cebolla Crispy",
    topping2: "Pimientos ahumados",
    topping3: "Salsa Criolla",
    topping4: "Salsa Alioli",
    topping5: "",
  },
];
  ...
  function IniciarProductos2() {
    ...
    burgerDobles.forEach((producto) => {
      ...
      divProducto2.setAttribute("data-aos-once", "true");  */
